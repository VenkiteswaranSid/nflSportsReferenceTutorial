...
passing_df_function <- function(year) {
  ## Create a URL for the passing data
  ...
  ## For loop to remove all instances of the stat QBR
  for (i in colnames(temp_passing_df)) {
    if (i == 'QBR') {
      temp_passing_df = temp_passing_df %>%
        select(-QBR)
      
      ## Renaming the columns 
      colnames(temp_passing_df)[c(11,14,16,17,19,20,21,22,24,25,26,27,28,29)] = c("Cmp_percentage","TD_percentage","Int_percentage","First_downs","Yards_per_attempt","Adjusted_yards_per_attempt","Yards_per_completion","Yards_per_game","Sck","Sck_yards","Sck_percentage","Net_yards_per_attempt","Adjusted_net_yards_per_attempt","Fourth_quarter_comebacks")
      
    } 
    else {
      ## Renaming the columns 
      colnames(temp_passing_df)[c(11,14,16,17,19,20,21,22,25,26,27,28,29)] = c("Cmp_percentage","TD_percentage","Int_percentage","First_downs","Yards_per_attempt","Adjusted_yards_per_attempt","Yards_per_completion","Yards_per_game","Sck_yards","Sck_percentage","Net_yards_per_attempt","Adjusted_net_yards_per_attempt","Fourth_quarter_comebacks")
    }
  }
